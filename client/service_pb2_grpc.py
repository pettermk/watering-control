...
class WaterControllerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SetConfig = channel.unary_unary(
                ...
                request_serializer=service__pb2.Configurations.SerializeToString,
...
def add_WaterControllerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'SetConfig': grpc.unary_unary_rpc_method_handler(
                    servicer.SetConfig,
                    request_deserializer=service__pb2.Configurations.FromString,
...
class WaterController(object):
    ...
    def SetConfig(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/WaterController/SetConfig',
            service__pb2.Configurations.SerializeToString,
